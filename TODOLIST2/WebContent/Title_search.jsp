...
<body>
	...
	<div class="container">
	<div class="row" style="text-align: center; margin: 0 auto; line-height:50px; border-radius: 5px; box-shadow: rgba(0,0,0,0.8) 0 0 10px; height:50px; background-color: #42579D;">
			<div class="col-xs-4 col-md-pull-0">
			<div class="form-group" style="text-align:center; margin: 0 auto;">
			<div class="btn-group" data-toggle="buttons">
				 		<label class="btn btn-primary">
				 			<input type="radio" onclick="printFunction();">Print
				 		</label>
				 		<label class="btn btn-primary">
			...
			<div class="col-xs-7" style="line-height:50px;padding-top:9px">
				<input class="form-control" id="userTitle" onkeyup="searchFunction()" type="text" size="40" placeholder="Title로 따로보기">
			</div>
			<div class="col-xs-1">
				<button type="button" id="printPageButton" onclick="searchFunction();" class="btn btn-primary">검색</button>
			</div>				
			</div>
		 </div>
		 	<table id="TableToExcel" class="table" style="text-align: center; border-radius: 5px; box-shadow: rgba(0,0,0,0.8) 0 0 10px;">
			<thead>
		 	<tr>
