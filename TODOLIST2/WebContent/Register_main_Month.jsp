...
<body>
	...
	<table class="table table-striped" style="text-align: center;  border-radius: 5px; box-shadow: rgba(0,0,0,0.8) 0 0 10px;">
				...
				%>	
				<tr>
				<td style="background-color: #fafafa; text-align: center; "><a href="view_Month.jsp?bbsID=<%= list.get(i).getBbsID()%>"><%= list.get(i).getUserTitle()%></a></td> 
				...
				<a href="write_Month.jsp?userID=<%=userID%>" style="box-shadow: rgba(0,0,0,0.8) 0 0 5px;" class="btn btn-primary pull-right">글쓰기</a>
	</div>
	</div>
