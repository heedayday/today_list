...
<body>
	...
	<div class="container">
		<div class="row">
		<form method="post" action="writeAction_MonthA.jsp?userID=<%=userID %>">
			...
			<input type="submit" class="btn btn-primary pull-right" style="box-shadow: rgba(0,0,0,0.8) 0 0 3px;" value="추가">
