...
<body>
	...
	<!--  <div class="container">-->
		<form method="post" action="writeAction_BT.jsp?userID=<%=userID %>">
		  ...
		  <table class="table table-striped" style="text-align: center; border-radius: 5px; box-shadow: rgba(0,0,0,0.8) 0 0 10px;">
				<thead>					
					<tr> 		
			 		...
			 		<h3><span style="color: white">YESTERDAY LIST</span>&nbsp;&nbsp;&nbsp;<button type="button" onclick="location.href='Register_main_M2.jsp?userID=<%=userID %>'" class="btn btn-secondary">></button></h3></th>
			 		</tr>				
					<tr>					
				...
				<%			
					...
					String userDate= yesterday;			
					UserDataDAO userdataDAO = new UserDataDAO();
					ArrayList<UserData> list = userdataDAO.getList3(userID,userDate);
					for(int i=0;i< list.size(); i++){
				%>	
				<tr>				
				<td style="background-color: #fafafa;  text-align:center; border-bottom-left-radius: 5px; border-top-left-radius: 5px;"><a href="view_BT.jsp?bbsID=<%= list.get(i).getBbsID()%>"><%= list.get(i).getUserTitle()%></a></td> 				
