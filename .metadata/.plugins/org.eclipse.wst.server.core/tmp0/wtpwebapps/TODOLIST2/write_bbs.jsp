...
<body>
	...
	<div class="container">
		<div class="row">
		<form method="post" action="writeAction_bbs.jsp?userID=<%=userID %>">
			...
			<a href="bbs.jsp?userID=<%=userID %>" style="box-shadow: rgba(0,0,0,0.8) 0 0 3px;"  class="btn btn-primary">목록</a>
