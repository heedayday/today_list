...
<body>
	...
	<div class="container">
		...
		<a href="Register_main_Month.jsp?userID=<%=userID %>" class="btn btn-primary" style="box-shadow: rgba(0,0,0,0.8) 0 0 3px;">목록</a>
		<%
			if(userID != null && userID.equals(bbs.getUserID())){
		%>
			<a href="update_Month.jsp?bbsID=<%= bbsID %>" class="btn btn-primary" style="box-shadow: rgba(0,0,0,0.8) 0 0 3px;">수정</a>
			<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction_Month.jsp?bbsID=<%= bbsID %>" class="btn btn-primary" style="box-shadow: rgba(0,0,0,0.8) 0 0 3px;">삭제</a>
