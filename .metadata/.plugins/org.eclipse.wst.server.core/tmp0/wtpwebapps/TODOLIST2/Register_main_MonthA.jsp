		  	...
		  	<table class="table table-striped" style="text-align: center;  border-radius: 5px; box-shadow: rgba(0,0,0,0.8) 0 0 10px;">
				<thead>					
					<tr> 		
			 		...
			 		<h3><button type="button" onclick="location.href='Register_main_Month.jsp?userID=<%=userID %>'" class="btn btn-secondary"><</button>&nbsp;&nbsp;&nbsp;<span style="color: white">NEXT MONTH</span></h3></th>
			 		</tr>				
					<tr>
				...
				<td style="background-color: #fafafa;  text-align:center;"><a href="view_MonthA.jsp?bbsID=<%= list.get(i).getBbsID()%>"><%= list.get(i).getUserTitle()%></a></td> 
				...
				<a href="write_MonthA.jsp?userID=<%=userID%>" style="box-shadow: rgba(0,0,0,0.8) 0 0 5px;"  class="btn btn-primary pull-right">글쓰기</a>
		  </div>
	</div>
